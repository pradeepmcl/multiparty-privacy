insert into image(name, stakeholders, image_description, sharer, sharing_description) values
  ...
  ('family-highSens-posSenti.jpg', 'Philip,Dolores,Ann', 'Dolores and Philip decide to have their baby, Rose, at home with the help of Ann, who is Dolores'' sister and a doula. They took the picture below during the labor.', 'Philip', 'Philip wants to upload the picture to his social media account, a few days after Rose was born.'),
  ...
  ('friends-lowSens-posSenti.png', 'Tim,Ashley,Jerry', 'Tim, Ashley, and Jerry just graduated. Tim''s father took the picture below after the graduation ceremony.', 'Tim', 'Tim wants to upload the picture to his social media account.'),
  ('friends-lowSens-negSenti.jpg', 'Santosh,Arun,Nitin', 'Three friends, Santosh, Arun, and Nitin, decided to perform some stunts on a motorcycle. Unfortunately, while performing a stunt, Arun and Nitin had a minor accident. Santosh took the photo below at that very moment.', 'Santosh', 'Santosh wants to upload the picture to his social media account.'),
  ('friends-highSens-posSenti.png', 'Mark,Alex,John', 'Three friends, Mark (the groom), Alex, and John, go on a boat in Ibiza during a bachelor party. They get drunk and meet some girls. The following is one of the pictures Alex took during that party.', 'Alex', 'Alex wants to upload the picture to his social media account, the day after the party.'),
  ('friends-highSens-negSenti.jpg', 'Vanessa,Natasha,Jessica', 'The picture below is from an end-of-semester party Vanessa (the girl wearing dark shirt with the US flag on it) hosted. The party went wild and a neighbor called the police. There was some tension after the police arrived and a few people invited to the party were arrested. The picture also shows Vanessa''s friends Natasha (the girl on the grass) and Jessica (the girl at the very left of the picture). Vanessa and her friends felt that the police abused their authority.', 'Vanessa', 'Vanessa wants to upload the picture to her social media account, a few days after the incident.'),
