insert into image(name, stakeholders, image_description, sharer, sharing_description) values
  ...
  ('family-highSens.png', 'Mary,Sophia,Charles', 'Mary, Sophia, and Charles attend their mother''s funeral. Another family member takes some pictures and circulates them among the family members.', 'Mary', 'Mary wants to share the above picture on social media.'),
